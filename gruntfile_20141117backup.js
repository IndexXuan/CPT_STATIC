...
/*            
            combine: {
                files: {
                  'build/css/xx_layout.css': ['assets/css/xx_layout.css'],
                  'build/css/app1.css': ['assets/css/app1.css']
                }
            }
*/
        },
/*
        uglify: {
            build: {
                files: {
                    'build/js/base.js': ['assets/js/core/gmu.js'],
                    'build/js/base.js': ['assets/js/core/event.js'],
                    'build/js/base.js': ['assets/js/core/widget.js'],
